(function matrixsSharedUi() {
  ...
  function currentRoute(pathname) {
    ...
    if (pathname.startsWith("/guide") || pathname.startsWith("/mcp")) return "/guide";
    return "";
  }
  ...
  function buildBar() {
    ...
    var links = reliabilityApp ? [
      ...
      ["/", "Workbench"],
      ["https://software-reliability-engine.onrender.com/dashboard", "Reliability"],
      ["https://software-reliability-engine.onrender.com/onboarding", "Setup"],
      ["/code", "Code"],
      ["/guide", "Docs"]
    ];
    var ctaHref = reliabilityApp ? "/onboarding" : "https://software-reliability-engine.onrender.com/dashboard";
    var ctaLabel = reliabilityApp ? "Connect a project" : "Open reliability";
